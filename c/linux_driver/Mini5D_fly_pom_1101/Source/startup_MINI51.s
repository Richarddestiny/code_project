...
Stack_Size      EQU     0x00000400                         ;栈区最大字节数
...
; Vector Table Mapped to Address 0 at Reset
                ...
                EXPORT  __Vectors
                                                           ;中断向量——各中断函数名
__Vectors       DCD     __initial_sp              ; Top of Stack       栈首址
                DCD     Reset_Handler             ; Reset Handler      复位向量
                DCD     NMI_Handler               ; NMI Handler        非屏蔽中断
                DCD     HardFault_Handler         ; Hard Fault Handler,硬件故障
                DCD     0                         ; Reserved
                DCD     0                         ; Reserved
                DCD     0                         ; Reserved
                DCD     0                         ; Reserved
                ...
                DCD     0                         ; Reserved
                DCD     0                         ; Reserved
                DCD     PendSV_Handler            ; PendSV Handler  挂起服务中断,常用于任务切换
                DCD     SysTick_Handler           ; SysTick Handler 系统时钟中断
...
Reset_Handler   PROC
                ...
                ; Init POR
                LDR     R2, =0x50000024                    ;POR的地址
                LDR     R1, =0x00005AA5                    ;关POR,防止干扰
                STR     R1, [R2]
                ...
                LDR     R0, =SystemInit                    ;执行最紧急代码
                BLX     R0
                LDR     R0, =__main                        ;跳到Keil的__main函数
                BX      R0                                 ;Keil会先把全局变量初始化
                ENDP                                       ;再去执行用户的main()
