...
#define CHIP_ADDR 0x27
#define I2C_DEV "/dev/i2c-4"//i2c_dev为i2c　adapter创建的别名
...
int main(void){
    ...
    res = ioctl(fd,I2C_TENBIT,0);   //not 10bit
           res = ioctl(fd,I2C_SLAVE,0x27);    //设置I2C从设备地址[6:0]


#if 0
   // printf("please input slave addr:");
   // scanf("%x",&slaveaddr);
    printf("input slave addr is:%x\n",CHIP_ADDR);
