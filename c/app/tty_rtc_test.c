...
int main(void)
{
   	 int fd = 0;	
	int nread,nwrite;
//	unsigned char buff[18]={0x68,0x99,0x99,0x99,0x99,0x99,0x99,0x68,0x08,0x06,0x00,0x0f,0x09,0x14,0x06,0x0D,0xb3,0x16};
	...
	nwrite = write(fd,buff,sizeof(buff)/sizeof(unsigned char));
	printf("1_nwrite = %d\n", nwrite);
