...
typedef enum
{
    ...
    /**
     *  Enable interpolation filtering
     *  Both Horizontal and vertical filtering is always turned on
     *
     *  This is deprecated, please use Smart filter instead
     *  (Bug 1233451)
     */
    NvDdk2dStretchFilter_Linear,
    NvDdk2dStretchFilter_Nicest = NvDdk2dStretchFilter_Linear,

    /**
     *  Enable intelligent filtering
     *  Horizontal or Vertical filtering is turned on only if needed
     *  i.e. only when src and dst size changes
     *
     *  Set interpolation filter for magnification and low-pass filter
     *  for minification
     */
