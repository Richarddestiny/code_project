...
#define TEGRA_CAMERA_IOCTL_ENABLE               _IOWR('i', 1, unsigned int)
#define TEGRA_CAMERA_IOCTL_DISABLE              _IOWR('i', 2, unsigned int)
#define TEGRA_CAMERA_IOCTL_CLK_SET_RATE         \
    _IOWR('i', 3, struct tegra_camera_clk_info)
#define TEGRA_CAMERA_IOCTL_RESET                _IOWR('i', 4, unsigned int)
