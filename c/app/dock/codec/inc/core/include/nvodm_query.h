...
/**
 * Table of electrical characteristics for HDMI
 */
typedef struct
{
    // HDMI_NV_PDISP_SOR_PLL0_0
    NvU32 Pll0;

    // HDMI_NV_PDISP_SOR_PLL1_0
    NvU32 Pll1;

    // HDMI_NV_PDISP_PE_CURRENT_0
    NvU32 PeCurrent;

} NvOdmQueryTmdsConfig;
...
/**
 * Defines images to display.
 */
typedef enum
{
    NvOdmImage_Nvidia,
    NvOdmImage_Lowbattery,
    NvOdmImage_Charging,
    NvOdmImage_Charged,
...
/**
 * Gets the null-terminated target_device (indicates bsp) name.
 *
 * @return A pointer to the target_device string.
 */
const NvU8* NvOdmQueryTargetDevice(void);
...
NvOdmQueryTmdsConfig *NvOdmQueryGetTmdsSettings(void);
