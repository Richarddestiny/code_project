...
typedef struct NvRmMemHandleAttrRec {
     ...
     */
    NvRmMemKind         Kind __DEPRECATED__;
    /**
     * Optional Compression Tags associated per compressed block.
     */
    NvRmMemCompressionTags CompTags __DEPRECATED__;
    /**
     * If true, contiguous physical memory allocation is required. However, that
     * will set platform-specific restrictions on how big memory areas can be
     * allocated.
     */
    NvBool Contiguous;
} NvRmMemHandleAttr;
...
#define NVRM_DEFINE_MEM_HANDLE_ATTR(x) \
    NvRmMemHandleAttr x = { 0,0,0,(NvOsMemAttribute)0,0,0,0,(NvRmMemKind)0,(NvRmMemCompressionTags)0,0 }
...
#define NVRM_MEM_HANDLE_SET_CONTIGUOUS_ATTR(attr, cont) \
    do { \
        attr.Contiguous = cont; \
    } while (0)
 ...
 */
 NvError NvRmMemAlloc(
    ...
    NvU32 NumHeaps,
    NvU32 Alignment,
    NvOsMemAttribute Coherency ) __DEPRECATED__;
 ...
 */
 NvError NvRmMemAllocBlocklinear(
    ...
    NvOsMemAttribute Coherency,
    NvRmMemKind Kind,
    NvRmMemCompressionTags CompressionTags ) __DEPRECATED__;
 ...
 */
 NvError NvRmMemHandleAlloc(
    ...
    NvU16 Tags,
    NvBool ReclaimCache,
    NvRmMemHandle * phMem ) __DEPRECATED__;
...
/**
 * This API is deprecated. Should be done via consumer subsystem as we
 * need to support multiple address space.
 */
 NvUPtr NvRmMemPin(
    NvRmMemHandle hMem ) __DEPRECATED__;
...
void NvRmMemCacheMaint(
    ...
    NvU32         Size,
    NvBool        WriteBack,
    NvBool        Invalidate) __DEPRECATED__;
...
/**
 * This API is deprecated. Caller should keep this info by itself.
 */
...
/**
 * This API is deprecated. Use NvRmMemMap() instead.
 */
...
/**
 * This API is deprecated. Use NvRmMemGetFd() instead.
 */
NvU32 NvRmMemGetId(
    NvRmMemHandle hMem ) __DEPRECATED__;

/**
 * This API is deprecated. Use NvRmMemHandleFromFd instead.
 */
...
/**
 * This should be called after CPU writes to
 * NvOsMemAttribute_WriteCombined memory, in order
 * to ensure coherency with hardware engines.
 */

#define NvRmMemorySync() asm volatile("dsb sy" : : : "memory")
