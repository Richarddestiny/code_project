...
#define NV_IMAGER_TPGCBAYER_ID  (NV_ODM_GUID('N','V','I','M','G','T','C','B'))
#define NV_IMAGER_TPGDBAYER_ID  (NV_ODM_GUID('N','V','I','M','G','T','D','B'))
...
typedef enum
{
    ...
    NvOdmBoardTouchPanelId_Loki_JDI5,
    NvOdmBoardTouchPanelId_TN8_Wintek,
...
/**
 * Holds audio codec board information, currently not supported.
 */
